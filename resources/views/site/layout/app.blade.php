...
<head>
  ...
  <link rel="stylesheet" href="{{asset('site/plugins/themefisher-font/style.css')  }}">
  <!-- bootstrap.min css -->
  <link rel="stylesheet" href="{{asset('site/plugins/bootstrap/bootstrap.min.css') }}">
  <!-- Lightbox.min css -->
  <link rel="stylesheet" href="{{ asset('site/plugins/lightbox2/css/lightbox.min.css') }}">
  <!-- animation css -->
  <link rel="stylesheet" href="{{ asset('site/plugins/animate/animate.css') }}">
  <!-- Slick Carousel -->
  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light px-0">
      ...
      <a class="navbar-brand logo" href="index.html">
        <img loading="lazy" class="logo-default" src="{{ asset('site/images/logo.png') }}" alt="logo" />
        <img loading="lazy" class="logo-white" src="{{ asset('site/images/logo-white.png') }}" alt="logo" />
      </a>
      <!-- /logo -->
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav ml-auto text-center">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="portfolio.html">Blog</a>
          </li>
          <li class="nav-item ">
...
{{-- <div class="hero-slider">
	<div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('site/images/slider/slider-bg-1.jpg') }});">
		<div class="container">
			<div class="row">
	...
	<div class="slider-item th-fullpage hero-area" style="background-image: url({{ asset('site/images/slider/slider-bg-2.jpg') }});">
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center d-none d-md-block">
        <img loading="lazy" src="{{ asset('site/images/about/member.jpg') }}" class="img-fluid inline-block" alt="">
      </div>
      <div class="col-md-8">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 mb-4 mb-md-0">
				<img loading="lazy" src="{{ asset('site/images/about/about-2.png') }}" class="img-fluid" alt="">
			</div>
			<div class="col-md-6">
				<ul class="checklist">
					...
					<div class="testimonial-slider">
						...
						<div class="item text-center">
							...
							<div class="client-thumb">
								<img loading="lazy" src="{{ asset('site/images/client-logo/clients-1.jpg')}}" class="img-fluid" alt="">
							</div>
						...
						<div class="item text-center">
							...
							<!-- client photo -->
							<div class="client-thumb">
								<img loading="lazy" src="{{ asset('site/images/client-logo/clients-2.jpg')}}" class="img-fluid" alt="">
							</div>
							<div class="client-meta">
								<h3>Emma Harrison</h3>
								<span>CEO , Company Name</span>
						...
						<div class="item text-center">
							...
							<!-- client photo -->
							<div class="client-thumb">
								<img loading="lazy" src="{{ asset('site/images/client-logo/clients-3.jpg')}}" class="img-fluid" alt="">
							</div>
							<div class="client-meta">
...
<!-- Parallax -->
<script src="{{ asset('site/plugins/parallax/jquery.parallax-1.1.3.js') }}"></script>

<!-- lightbox -->
<script src="{{ asset('site/plugins/lightbox2/js/lightbox.min.js') }}"></script>

<!-- Owl Carousel -->
<script src="{{ asset('site/plugins/slick/slick.min.js') }}"></script>

<!-- filter -->
<script src="{{ asset('site/plugins/filterizr/jquery.filterizr.min.js') }}"></script>

<!-- Smooth Scroll js -->
<script src="{{ asset('site/plugins/smooth-scroll/smooth-scroll.min.js') }}"></script>
