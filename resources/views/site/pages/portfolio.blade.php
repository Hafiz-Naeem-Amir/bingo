						...
						<div class="filtr-container">
							<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design">
								<div class="portfolio-block">
									<img class="img-fluid" src="{{asset('site/images/portfolio/portfolio-1.jpg')}}" alt="">
									<div class="caption">
							...
							<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design, ios">
								<div class="portfolio-block">
									<img class="img-fluid" src="{{asset('site/images/portfolio/portfolio-2.jpg')}}" alt="">
									<div class="caption">
							...
							<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography, development">
								<div class="portfolio-block">
									<img class="img-fluid" src="{{asset('site/images/portfolio/portfolio-3.jpg')}}" alt="">
									<div class="caption">
							...
							<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography, ios">
								<div class="portfolio-block">
									<img class="img-fluid" src="{{asset('site/images/portfolio/portfolio-4.jpg')}}" alt="">
									<div class="caption">
							...
							<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design">
								<div class="portfolio-block">
									<img class="img-fluid" src="{{asset('site/images/portfolio/portfolio-5.jpg')}}" alt="">
									<div class="caption">
							...
							<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design, development">
								<div class="portfolio-block">
									<img class="img-fluid" src="{{asset('site/images/portfolio/portfolio-6.jpg')}}" alt="">
									<div class="caption">
							...
							<div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography">
								<div class="portfolio-block">
									<img class="img-fluid" src="{{asset('site/images/portfolio/portfolio-7.jpg')}}" alt="">
									<div class="caption">
