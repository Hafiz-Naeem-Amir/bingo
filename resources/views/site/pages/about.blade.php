	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 mt-4 mt-lg-0">
				<img loading="lazy" class="img-fluid" src="{{asset('site/images/company/company-image.jpg')}}" alt="">
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<img loading="lazy" src="{{asset('site/images/company/company-image-2.jpg')}}" alt="" class="img-fluid mt-30">
			</div>
			<div class="col-md-6 mt-5 mt-md-0">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere in suscipit voluptatum totam dolores
					...
					inventore! Culpa nemo aspernatur tenetur, at quam aliquid reprehenderit obcaecati dicta illum mollitia,
					perferendis hic, beatae voluptates? Ex labore, obcaecati harum nam.</p>
				<img loading="lazy" src="{{asset('site/images/company/company-image-3.jpg')}}" alt="" class="img-fluid mt-30">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="company-gallery">
					<img loading="lazy" src="{{asset('site/images/company/gallery-1.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-2.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-3.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-4.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-5.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-5.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-1.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-2.jpg')}}" alt="">
					<img loading="lazy" src="{{asset('site/images/company/gallery-3.jpg')}}" alt="">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img loading="lazy" class="img-fluid" src="{{asset('site/images/team/member-1.jpg')}}" alt="Meghna">
						<!-- /member photo -->
			...
			<div class="col-lg-4 col-md-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img loading="lazy" class="img-fluid" src="{{asset('site/images/team/member-2.jpg')}}" alt="Meghna">
						<!-- /member photo -->
			...
			<div class="col-lg-4 col-md-6">
				<div class="team-member text-center">
					<div class="member-photo">
						<!-- member photo -->
						<img loading="lazy" class="img-fluid" src="{{asset('site/images/team/member-3.jpg')}}" alt="Meghna">
						<!-- /member photo -->
